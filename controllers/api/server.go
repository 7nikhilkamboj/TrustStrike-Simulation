...
func (as *Server) registerRoutes() {
	...
	router.HandleFunc("/campaigns/{id:[0-9]+}", as.Campaign).Methods("GET")
	router.HandleFunc("/campaigns/{id:[0-9]+}", mid.Use(as.Campaign, mid.RequirePermission(models.PermissionModifySystem))).Methods("DELETE")
