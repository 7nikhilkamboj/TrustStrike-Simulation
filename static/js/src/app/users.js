        ...
        .done((us) => {
            ...
            $.each(users, (i, user) => {
                ...
                userRows.push([
                    ...
                    <button class='btn btn-primary edit_button' data-toggle='modal' data-backdrop='static' data-target='#modal' data-user-id='" + user.id + "' data-toggle='tooltip' title='Edit User'>\
