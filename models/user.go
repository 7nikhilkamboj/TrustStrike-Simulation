...
// accounts left in trust_strike with that role.
...
// GetUsers returns the users registered in trust_strike
...
// trust_strike with the Admin role. This function is meant to be called before
