...
scripts = function () {
    return gulp.src([
        ...
        app_directory + 'sending_profile_edit.js',
        app_directory + 'template_edit.js',
        app_directory + 'group_edit.js',
        app_directory + 'campaign_edit.js',
...
styles = function () {
    return gulp.src([
        ...
        css_directory + 'campaigns_redesign.css',
        css_directory + 'dashboard_redesign.css',
        css_directory + 'groups_redesign.css',
        css_directory + 'page_redesign.css',
        css_directory + 'nav_redesign.css'
    ])
        .pipe(cleanCSS({
            compatibilty: 'ie9'
        }))
        .pipe(concat('trust_strike.css'))
